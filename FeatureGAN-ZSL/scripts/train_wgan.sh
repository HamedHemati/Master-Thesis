...
python main.py --cuda --batch-size 64 --n-epochs 50 \
                ...
                --model 'WGAN' --use-gp 'no' --use-cent-loss 'no' --lambda-centl 1.0\
                ...
                --name-index '0' --random-seed 67232
...
python main.py --cuda --batch-size 64 --n-epochs 50 \
                ...
                --n-z 100 --n-h-d 4096 --n-h-g 4096 \
                --n-synth-samples 2500 --save-every 0 \
                --name-index '1' --random-seed 67232
...
python main.py --cuda --batch-size 64 --n-epochs 100 \
                ...
                --feat-type 'res101' --cls-emb-type 'att'\
                --n-iter-d 5 --lr 0.00001 --lambda-gp 10.0 --cls-weight 0.01 --n-cls-epochs 30\
                --n-z 300 --n-h-d 4096 --n-h-g 4096 \
                --n-synth-samples 500 --save-every 0 \
                --name-index '2' --random-seed 67232